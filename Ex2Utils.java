...
public class Ex2Utils {
    public static final int TEXT=1, NUMBER=2, FORM=3, FUNC=4, IF=5, ERR_FORM_FORMAT=-2, ERR_CYCLE_FORM=-1, ERR=-1 , ERR_FUNC_FORMAT=-4, ERR_IF_FORMAT=-5;
    public static final String ERR_CYCLE = "ERR_CYCLE!", ERR_FORM = "ERR_FORM!" , ERR_IF = "ERR_IF!" , ERR_FUNC = "ERR_FUNC!";
